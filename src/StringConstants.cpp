...
const char _MQTT_DEVICE_ID                 [] PROGMEM = "mqtt_device_id";
const char _MQTT_DEVICE_NAME               [] PROGMEM = "mqtt_device_name";
const char _OPEN                           [] PROGMEM = "OPEN";
const char _CLOSE                          [] PROGMEM = "CLOSE";
const char _OPENING                        [] PROGMEM = "OPENING";
const char _CLOSING                        [] PROGMEM = "CLOSING";
...
const char _ONLINE                         [] PROGMEM = "ONLINE";
const char _OFFLINE                        [] PROGMEM = "OFFLINE";
