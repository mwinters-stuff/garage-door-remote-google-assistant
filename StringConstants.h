...
extern const char _INFLUX_MEASUREMENT_TEMPERATURE[] PROGMEM;
extern const char _INFLUX_TEMPERATURE_TAGS[] PROGMEM;
extern const char _INFLUX_DOOR[] PROGMEM;

extern const char _MQTT_FEED_DOOR_SET_POSITION[] PROGMEM;
extern const char _MQTT_FEED_DOOR_REPORT_POSITION[] PROGMEM;
extern const char _MQTT_FEED_DOOR_SET_LOCKED[] PROGMEM;
extern const char _MQTT_FEED_DOOR_REPORT_LOCKED[] PROGMEM;
...
#define INFLUX_MEASUREMENT_TEMPERATURE FPSTR(_INFLUX_MEASUREMENT_TEMPERATURE)
#define INFLUX_TEMPERATURE_TAGS FPSTR(_INFLUX_TEMPERATURE_TAGS)
...
#define INFLUX_URL FPSTR(_INFLUX_URL)
 ...
 #define MQTT_FEED_DOOR_SET_POSITION FPSTR(_MQTT_FEED_DOOR_SET_POSITION)
 #define MQTT_FEED_DOOR_REPORT_POSITION FPSTR(_MQTT_FEED_DOOR_REPORT_POSITION)
 #define MQTT_FEED_DOOR_SET_LOCKED FPSTR(_MQTT_FEED_DOOR_SET_LOCKED)
 #define MQTT_FEED_DOOR_REPORT_LOCKED FPSTR(_MQTT_FEED_DOOR_REPORT_LOCKED)
